  ...
  return (
    <footer className="py-12 sm:py-16 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* TOP GRID */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-8 border-b border-black dark:border-white">
                ...
                {["/", "/Notes", "/About", "/Contact"].map((path, i) => {
                  ...
                  return (
                    <li key={i}>
                      <Link
                        href={path}
                        className="flex items-center group hover:text-black dark:hover:text-white transition-colors"
                      >
